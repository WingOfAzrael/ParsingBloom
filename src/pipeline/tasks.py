...
#
    ...
    _LOG.info("Flagged unparsed email", extra={"message_id": message_id})
    FlaggedTracker().flag(run_id, message_id, sender, subject, reason)
    return None



def export_transactions(parsed: List[Optional[BaseModel]]) -> int:
    """
